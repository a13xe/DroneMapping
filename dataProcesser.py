...
def importData(fileName, imageDirectory):
    ...
    ===============================================================================================
    Возвращает: dataMatrix (Тип: NumPy ndArray) - массив, содержащий все данные позиции, где в каждой 
        строке хранится 6 плавающих элементов, содержащих информацию в форме [XYZYPR].
    Возвращает: allImages (Тип: NumPy ndArray) - список, который содержит изображения.
    ===============================================================================================
    '''
